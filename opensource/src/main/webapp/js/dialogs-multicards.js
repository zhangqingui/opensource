...
(function($){
	...
	JRJ.MultiCards.Dialogs = {
		...
		iframeDialog: function (config) {
		    ...
		    html += '<i class="mc-title-icon jrj-fl"></i><span class="jrj-fl middle">' + self.config.title + '</span><span class="jrj-fl" style="font-weight:normal;font-size:14px;color:#808080;">（客服电话 400-850-7771）</span>';
