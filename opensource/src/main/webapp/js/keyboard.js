...
//                '<li class="space"></li>',
            ...
            if ($('#keyboard').length == 0 || typeof $('#keyboard').length == 'undefined') {
                $('body').append($(tmpl));
                $('#keyboard').css({ top: settings.triggerObj.offset().top, left: settings.triggerObj.offset().left + settings.triggerObj.width()+10 }).show();
                return true;
            } else {
                $('#keyboard').hide().css({ top: settings.triggerObj.offset().top, left: settings.triggerObj.offset().left + settings.triggerObj.width()+10 }).show();
                return false;
            }
