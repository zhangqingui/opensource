...
}(function ($)
{
    ...
    function Scrollbar($container, options)
    {
        ...
        this.update = function(scrollTo)
        {
            ...
            viewportSize    = $viewport.height();//$viewport[0]['offset'+ sizeLabelCap];
            contentSize     = Math.max($overview.height(), $overview.find('iframe').height());//$overview[0]['scroll'+ sizeLabelCap];
        ...
        function setEvents()
        {
            ...
            if(options.wheel){
	            ...
	            if ($container[0].attachEvent){
	            	$container[0].attachEvent("on"+mousewheelevt, wheel);
	            	$container.find('iframe')[0].contentWindow.document.attachEvent("on"+mousewheelevt, wheel);
	            }else if($container[0].addEventListener){
	            	$container[0].addEventListener(mousewheelevt, wheel, false );
	            	$container.find('iframe')[0].contentWindow.document.addEventListener(mousewheelevt, wheel, false );
	            }
